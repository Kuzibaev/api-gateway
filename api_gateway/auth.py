...
from exceptions import AuthTokenExpired, AuthTokenCorrupted, AuthTokenMissing
...
def generate_access_token(data: dict,
                          expires_delta: timedelta = timedelta(settings.ACCESS_TOKEN_DEFAULT_EXPIRE_MINUTES)):
