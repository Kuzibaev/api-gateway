    ...
    def wrapper(f):
        ...
        async def inner(request: Request, response: Response, **kwargs):
            ...
            if authentication_required:
                ...
                exc = None
                try:
                    token_payload = token_decoder(authorization)  # noqa
                ...
                if service_authorization_checker:
                    ...
                    is_user_eligible = authorization_checker(token_payload)  # noqa
                ...
                if service_header_generator:
                    ...
                    service_headers = header_generator(token_payload)  # noqa

            scope = request.scope

            method = scope['method'].lower()
            path = scope['path']  # noqa
